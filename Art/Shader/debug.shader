Shader "Unlit/debug"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //#include "C:\Users\jiacheng.fan\ProjectWithURP\Assets\Art\Shader\HairBxDF.cginc"
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                //struct SurfaceOutputHair mys;
                //mys.Albedo = half3(0.5,0,0.3)
                //float3 temp = HairBxDF(mys, direction, mywnormal)
