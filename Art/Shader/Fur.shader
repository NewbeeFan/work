Shader "Custom/Fur"
{
	...
	{	
		...
		CGPROGRAM
		#include "FurSurf.cginc"
		#pragma surface surf Fur fullforwardshadows vertex:vert
		...
		void surf(Input IN, inout SurfaceOutputFur o)
		{
			...
			o.Kappa = _Kappa;
			o.Layer = _Layer;
			o.MedulaScatter = _MedulaScatter;
			o.MedulaAbsorb = _MedulaAbsorb;
		}
		ENDCG
	}
	SubShader
