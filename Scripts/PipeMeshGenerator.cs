...
public class PipeMeshGenerator : MonoBehaviour {
    ...
    private Vector3[] line_points = new Vector3[500];
    ...
    void Start() {
        ...
        lineObjects = new GameObject[500];
        for (int i = 0; i < 800; i++)
		{
    ...
    public void RenderPipe(Vector3[] points) {
    ...
    void GenerateCircleAtPoint(List<Vector3> vertices, List<Vector3> normals, Vector3 center, Vector3 direction) {
        ...
        Debug.Log("totalnum="+vertices.Count);
    }
    ...
    void MakeCylinderTriangles(List<int> triangles, int segmentIdx) {
        ...
        Debug.Log("totalnum_tri="+triangles.Count);
    }
    /*
